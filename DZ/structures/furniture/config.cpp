...
//'now' is Tue May 31 17:03:46 2022 : 'file' last modified on Wed Dec 31 19:00:01 1969
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\pc\pc.p3d";
	};
	class Static_Furniture_phonebox: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\phonebox\phonebox.p3d";
	};
	class Static_Furniture_pokladna: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\pokladna\pokladna.p3d";
	};
	class Static_Furniture_radio_b: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\radio_b\radio_b.p3d";
	};
	class Static_Furniture_tv_a: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\tv_a\tv_a.p3d";
	};
	class Static_Furniture_vending_machine: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\vending_machine\vending_machine.p3d";
	};
	class Static_Furniture_washing_machine: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\Electrical_appliances\washing_machine\washing_machine.p3d";
	};
	...
	{
		scope = 2;
		model = "DZ\structures\Furniture\kitchen\KitchenDesk\Kitchen_desk_A.p3d";
	};
	class Static_Furniture_Kitchen_desk_B: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Furniture\kitchen\KitchenDesk\Kitchen_desk_B.p3d";
	};
