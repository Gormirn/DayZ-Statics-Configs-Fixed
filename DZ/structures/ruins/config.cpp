...
//'now' is Tue May 31 17:05:10 2022 : 'file' last modified on Wed Dec 31 19:00:01 1969
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class Static_Rubble_Bricks1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Bricks1.p3d";
	};
	class Static_Rubble_Bricks2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Bricks2.p3d";
	};
	class Static_Rubble_Bricks3: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Bricks3.p3d";
	};
	class Static_Rubble_Concrete1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Concrete1.p3d";
	};
	class Static_Rubble_Concrete2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Concrete2.p3d";
	};
	class Static_Rubble_Concrete3: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Concrete3.p3d";
	};
	class Static_Rubble_DirtPile_Large: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_DirtPile_Large.p3d";
	};
	class Static_Rubble_DirtPile_Medium1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_DirtPile_Medium1.p3d";
	};
	class Static_Rubble_DirtPile_Medium2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_DirtPile_Medium2.p3d";
	};
	class Static_Rubble_Glass: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Glass.p3d";
	};
	class Static_Rubble_Metal1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Metal1.p3d";
	};
	class Static_Rubble_Metal2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Metal2.p3d";
	};
	class Static_Rubble_Metal3: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Metal3.p3d";
	};
	class Static_Rubble_Rocks1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Rocks1.p3d";
	};
	class Static_Rubble_Rocks2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Rocks2.p3d";
	};
	class Static_Rubble_Wood1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Wood1.p3d";
	};
	class Static_Rubble_Wood2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Wood2.p3d";
	};
	class Static_Rubble_Wood3: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Rubble_Wood3.p3d";
	};
	class Static_Ruin_Chimney: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_Chimney.p3d";
	};
	class Static_Ruin_Church: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_Church.p3d";
	};
	class Static_Ruin_Corner1: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_Corner1.p3d";
	};
	class Static_Ruin_Corner2: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_Corner2.p3d";
	};
	class Static_Ruin_DoorWall: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_DoorWall.p3d";
	};
	class Static_Ruin_House_Total: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_House_Total.p3d";
	};
	class Static_Ruin_HouseBlock_Corner_Total: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_HouseBlock_Corner_Total.p3d";
	};
	class Static_Ruin_HouseBlock_Half: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_HouseBlock_Half.p3d";
	};
	class Static_Ruin_HouseBlock_Total: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_HouseBlock_Total.p3d";
	};
	class Static_Ruin_Rubble: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Ruins\Ruin_Rubble.p3d";
	};
	class Static_Ruin_Wall: HouseNoDestruct
	{
		scope = 2;
