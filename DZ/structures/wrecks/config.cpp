...
class CfgVehicles
{
	...
	class Static_Wreck_Mi8_Crashed: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Aircraft\Wreck_Mi8_Crashed.p3d";
	};
	class Static_Wreck_SantasSleigh: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Aircraft\Wreck_SantasSleigh.p3d";
	};
	...
	class Static_Wreck_Train_Wagon_Flat_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Flat.p3d";
	};
	class Static_Wreck_Train_Wagon_Flat_Mil_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Flat.p3d";
	};
	class Static_Train_Wagon_Flat_Industrial_Planks_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Flat.p3d";
	};
	class Static_Train_Wagon_Flat_Industrial_Logs_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Flat.p3d";
	};
	class Static_Train_Wagon_Flat_Industrial_Barrels_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Flat.p3d";
	};
	class Static_Wreck_Train_Wagon_Tanker_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Tanker.p3d";
	};
	class Static_Wreck_Train_Wagon_Tanker_Mil_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_Wagon_Tanker.p3d";
	};
	class Static_Wreck_Train_742_Blue_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_742_Blue.p3d";
	};
	class Static_Wreck_Train_742_Red_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_742_Red.p3d";
	};
	class Static_Wreck_Train_742_Blue_Mil_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_742_Blue.p3d";
	};
	class Static_Wreck_Train_742_Red_Mil_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Trains\Train_742_Red.p3d";
	};
	class Static_Wreck_BMP1_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Vehicles\Wreck_BMP1.p3d";
	};
	class Static_Wreck_BMP2_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Vehicles\Wreck_BMP2.p3d";
	};
	class Static_Wreck_BRDM_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Vehicles\Wreck_BRDM.p3d";
	};
	class Static_Wreck_Ural_DE: HouseNoDestruct
	{
		scope = 2;
		model = "DZ\structures\Wrecks\Vehicles\Wreck_Ural.p3d";
	};
